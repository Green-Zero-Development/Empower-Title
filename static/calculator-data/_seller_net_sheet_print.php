<?php
    ...
    for ( $kk = 1; $kk <= $_POST[ 'n_loans' ]; $kk++ ) {
    	if($_POST[ 'nloannn_' . $kk ] != ""){
    		$nloannn_x .= '<tr><td>Loan ' . $kk . '</td><td align="right">$' . @number_format( preg_replace( "/[^0-9.]/", "", $_POST[ 'nloannn_' . $kk ] ), 2 ) . '</td></tr>';
    	}else{
    		$nloannn_x .= '<tr><td>Loan ' . $kk . '</td><td align="right"></td></tr>';
    	}
...
';
	...
	$_POST[ 'repairs' ]    			  	= ($_POST[ 'repairs' ] == "") ? "" : "$".@number_format( $_POST[ 'repairs' ], 2 );
	$_POST[ 'warranty' ]    			= ($_POST[ 'warranty' ] == "") ? "" : "$".@number_format( $_POST[ 'warranty' ], 2 );
	$_POST[ 'pest' ]    			  	= ($_POST[ 'pest' ] == "") ? "" : "$".@number_format( $_POST[ 'pest' ], 2 );
	$_POST[ 'attorney_fee' ]    		= ($_POST[ 'attorney_fee' ] == "") ? "" : "$".@number_format( $_POST[ 'attorney_fee' ], 2 );
	$_POST[ 'hoa_transfer' ]			= ($_POST[ 'hoa_transfer' ] == "") ? "" : "$".@number_format( $_POST[ 'hoa_transfer' ], 2 );
	$_POST[ 'tax_certificate' ]    	  	= ($_POST[ 'tax_certificate' ] == "") ? "" : "$".@number_format( $_POST[ 'tax_certificate' ], 2 );
	$_POST[ 'seller_credit_to_buyer' ]	= ($_POST[ 'seller_credit_to_buyer' ] == "") ? "" : "$".@number_format( $_POST[ 'seller_credit_to_buyer' ], 2 );
